...
export default class MemGraph extends React.Component {
    ...
    componentDidMount () {
        ...
        ipcRenderer.on('getVariablesForGraphInitializer', function (evt, message) {
            ...
            //     if (nextNode !== '0x0') {
            //       that.getNode(element_temp, element_graph, element_id, key, nextNode)
            //     }
      
            //   } else { // if the element is not a linked list
            //     that.getNode(element_temp, element_graph, element_id, key, element_temp[key]['value'])
            //   }
